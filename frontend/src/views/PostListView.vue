...
.portal-stat-grid article { display:flex; align-items:baseline; gap:7px; padding:20px; border:1px solid rgba(52,91,67,.12); border-radius:16px; background:rgba(255,255,255,.72); box-shadow:0 10px 24px rgba(47,75,54,.06); }
...
.portal-board__tools { display:flex; justify-content:space-between; gap:14px; margin:22px 0 10px; padding:15px; border-radius:14px; background:#edf3df; }.portal-board__search { display:flex; flex:1; gap:7px; }.portal-board__search input { max-width:540px; }
.portal-post-table { border-top:2px solid #466c55; }.portal-post-table > button { display:grid; grid-template-columns:60px minmax(0,1fr) 150px; align-items:center; width:100%; padding:18px 10px; border:0; border-bottom:1px solid #dce5d8; background:rgba(255,255,255,.62); color:#304a39; text-align:left; }.portal-post-table > button:hover { background:#f8faf2; }.portal-post-table__number { color:#89988d; text-align:center; }.portal-post-table__content { display:grid; gap:5px; min-width:0; }.portal-post-table__content strong,.portal-post-table__content small { overflow:hidden; white-space:nowrap; text-overflow:ellipsis; }.portal-post-table__content small { color:#78867c; }.portal-post-table__meta { display:grid; gap:4px; color:#7d8b81; text-align:right; }.portal-post-table__meta b { color:#52705c; font-size:12px; }
